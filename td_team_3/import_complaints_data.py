...
DDL_FILE_PATH = Path("implementations/report_generation/data/Complaints.ddl")
...
def cli(dataset_path: str) -> None:
    ...
    """
    import_complaints_data(dataset_path)


def import_complaints_data(dataset_path: str) -> None:
    ...
    df["date_received"] = df["date_received"].apply(convert_date)
